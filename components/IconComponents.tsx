...
export const UploadCloudIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M20 16.2A4.5 4.5 0 0 0 15.5 8H14a6 6 0 0 0-12 0H2.5A2.5 2.5 0 0 0 0 10.5" />
...
export const TwitterIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.4 3.3 4.4s-1.4 1.2-2.1.8c-.7-.4-1.7-1-2.1-1.3-.4-.3-1.1.2-1.1.2s-1 .9-1.4 1.3c-.4.4-1.3.4-1.3.4s-4.3 1.8-7.7-2.2c-3.4-4-2.2-7.7-2.2-7.7s1.3.4 2.1.8c.8.4 1.7 1 2.1 1.3.4.3 1.1-.2 1.1-.2s1-.9 1.4-1.3c.4-.4 1.3-.4 1.3-.4s3.3-1.1 5.6 2.4c2.3 3.5 1.2 5.6 1.2 5.6z" />
    </svg>
);
